...
################################################################################
## Form generated from reading UI file 'MainWindowEditorDibujoLKEFQd.ui'
##
...
class Ui_MainWindowEditorDibujo(object):
    def setupUi(self, MainWindowEditorDibujo):
        ...
        self.gridLayout.addWidget(self.label_color_fondo, 11, 0, 1, 1)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/images/img/cursor.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pbutton_seleccionar.setIcon(icon4)
        ...
        self.gridLayout.addWidget(self.label_color_linea, 12, 0, 1, 1)

        self.pbutton_borrar = QPushButton(self.frame)
        self.pbutton_borrar.setObjectName(u"pbutton_borrar")
        icon5 = QIcon()
        icon5.addFile(u":/images/img/delete.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pbutton_borrar.setIcon(icon5)

        self.gridLayout.addWidget(self.pbutton_borrar, 9, 0, 1, 1)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/images/img/rectangle.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pbutton_rect.setIcon(icon6)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/images/img/linea.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pbutton_linea.setIcon(icon8)
        ...
        self.gridLayout.addWidget(self.spin_ancho_linea, 13, 0, 1, 1)

        self.combo_tipo_linea = QComboBox(self.frame)
        self.combo_tipo_linea.addItem(icon8, "")
        icon9 = QIcon()
        icon9.addFile(u":/images/img/dashed.png", QSize(), QIcon.Normal, QIcon.Off)
        self.combo_tipo_linea.addItem(icon9, "")
        icon10 = QIcon()
        icon10.addFile(u":/images/img/puntos.png", QSize(), QIcon.Normal, QIcon.Off)
        self.combo_tipo_linea.addItem(icon10, "")
        self.combo_tipo_linea.setObjectName(u"combo_tipo_linea")

        self.gridLayout.addWidget(self.combo_tipo_linea, 14, 0, 1, 1)
